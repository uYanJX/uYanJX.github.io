...
大家好！我是 **晏健鑫**，目前是本科三年级，就读于 [武汉大学国家网络安全学院]([https://www.whu.edu.cn/](https://cse.whu.edu.cn/)) 信息安全专业。

我对网络安全和人工智能充满热情，自入学以来，积极参与各类科研项目和学术竞赛，曾获得国家奖学金、绿盟科技奖学金、雷军计算机科研实践基金、全国数学建模国二和多项校内外奖项。在科研方面，我参与并主导了多个项目，包括但不限于**推荐系统**、**多模态**、**人工智能安全**、**多媒体信息内容安全**等领域。

# 🎓 Education Background

- **排名：**综合素质测评排名： **6%** （9/144）、平均学分绩点排名： 9% （13/144）
- **成绩均分：**GPA：3.87/4.0、加权平均分：91.60/100
- **语言能力：**已通过 CET4 和 CET6，具备良好的英语文献阅读和写作能力
- **核心课程：**高等数学（97）、密码学（95）、信息系统安全（94）、信安数理基础（91）、数据新闻（95）、 人工智能实验（95）、概率论与数理统计（94）、编译原理（94）、社会计算（94）
- **编程能力：**熟练掌握 C++ 和 Python、熟悉算法与数据结构，抽象能力强，代码风格良好；熟练掌握 PyTorch、Numpy、Pandas，熟悉各类深度学习模型；长期担任数学建模编程手，曾获“全国大学生数学建模”国家二等奖（全国2%，total 54158 teams）
- **开发工具：**VS Code, PyCharm, Jupyter Notebook, LaTeX (Overleaf), Git
- **在校荣誉：**国家奖学金 （1%）、绿盟科技奖学金（3%）、雷军计算机科研实践基金、武汉大学三好学生、武汉大学优秀学生干部、武汉大学社会活动积极分子及多项竞赛奖金，在校累计获奖金额逾40000元

# 🔥 News

- *2024.06*：  🎉🎉 我获得了[**雷军计算机创新与发展资助基金（科研实践）**](https://cse.whu.edu.cn/info/1101/23802.htm)！
- *2024.05*：  🎉🎉 我们的作品**音达康护**在2024年第17届中国大学生计算机设计大赛(中南地区赛)中获得**物联网应用组一等奖**！
- *2024.03*：  🎉🎉 我获得了**绿盟科技网络安全奖学金**!
- *2023.11*：  🎉🎉 我们的作品在2023年高教社杯全国大学生数学建模竞赛大数据分析赛题中晋级国赛并获得**国家级二等奖**！
- *2023.08*：  🎉🎉 我们的作品**Voice Guard**在2023年武汉大学信息安全竞赛作品赛中获得[**二等奖**](https://cse.whu.edu.cn/info/1102/21552.htm)！
**！
...
* **我们的方法**：
  ...
  2. **对抗攻击技术的鲁棒性研究**：深入分析对抗样本在经历编解码、有损压缩等传输过程及常见的信号处理操作后的稳定性，基于 WaveGlow高斯扰动引入以确保技术的有效性。
  3. **跨数据集和模型的防御能力**：采用动态集成说话人编码器技术，并在Adam优化器基础上融入梯度正则化和锐度感知最小化，在未知（Unseen）场景下保护声纹，确保即便是在未见过的攻击手段下也能维持防御效果。
* **项目成果**：
  * 已获2023年武汉大学生信息安全竞赛二等奖，相关工作已进一步完善，正在参加2024年全国大学生信息安全竞赛。
...
* **我们的方法**：
  ...
  2. **微调适应特定的下游任务**：初期冻结ATST-Frame模型，而只训练CNN，让CNN学会与冻结的ATST-Frame特征相配合；接着采用频率扭曲和Mixup等数据增强方法来丰富居家类型音频数据集，再并行训练ATST-Frame与CNN。
  3. **集成视频实时行为检测**：融合YOLOv5、DeepSORT与SlowFast网络，实现端到端的多目标实时行为检测，以应对老年人无声无息的跌倒事件
* **项目成果**：
  * 第十二届“自强杯”大学生创业计划竞赛院[**第一名**](https://mp.weixin.qq.com/s/r4_IQ3H0mC6k8-AQ4fCjPA)。
